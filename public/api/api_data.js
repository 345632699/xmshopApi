define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/address/get/{id}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/address"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/client"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/good/{good_id}"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/order/create"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/order/get/{id}"
      }
    ]
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "order_status",
            "description": "<p>0-未支付，1-已支付，2-待发货，3-已发货，4-已完成，5-异常，6-申请退货，7-确认退货，8-已退货 -1 全部</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "order_status",
            "description": "<p>ORDER_STATUS：0-已下单，1-已支付，2-待发货，3-已发货，4-已完成，5-异常，6-申请退货，7-确认退货，8-已退货</p>"
          },
          {
            "group": "Success 200",
            "type": "datetime",
    ...
    "sampleRequest": [
      {
        "url": "http://www.xm.com/api/order/list/{order_status}"
      }
    ]
  }
] });
